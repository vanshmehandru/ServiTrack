...
const Navbar = ({ title }) => {
  ...
  return (
    <header className="h-20 sticky top-0 bg-bg-primary/80 border-b border-border-color flex items-center justify-between px-10 z-[40] backdrop-blur-md transition-colors duration-300">
      <div className="flex-1 max-w-xl group">
        <div className="relative flex items-center">
            ...
            <input 
              ...
              className="premium-input w-full pl-11 pr-4 py-2 text-[13px] bg-bg-secondary border-none focus:ring-1 focus:ring-brand" 
            />
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 pl-2 cursor-pointer group">
           <div className="text-right hidden sm:block">
              <div className="text-[13px] font-bold text-text-primary leading-none mb-1">{user.First_Name || 'Master'}</div>
